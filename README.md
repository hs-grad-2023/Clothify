...
- ### 사진으로 가상 피팅
    ...
    - ### 결과([VTON-HD](https://github.com/shadow2496/VITON-HD) 인공지능 모델 이용)
      ...
      - 생성형 네트워크로 구현된 VITON-HD로 자연스러운 착용 경험 가능
