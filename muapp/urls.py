...
urlpatterns = [
    ...
    path('virtual_fit_photo/',views.virtual_fit_photo, name='virtual_fit_photo'),
    path('virtual_fit_photo_result/',views.virtual_fit_photo_result, name='virtual_fit_photo_result'),
