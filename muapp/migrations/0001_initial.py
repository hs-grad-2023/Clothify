        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "sex",
                    models.CharField(
                        blank=True, max_length=1, null=True, verbose_name="성별"
                    ),
                ),
                (
                    "name",
                    models.CharField(
                        blank=True, max_length=4, null=True, verbose_name="이름"
                    ),
                ),
                (
                    "style",
                    models.CharField(
                        blank=True, max_length=50, null=True, verbose_name="스타일"
                    ),
                ),
                (
                    "groups",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ImageField(
                        blank=True,
                        default="imgfiles/no_image.png",
                        null=True,
                        upload_to="imgfiles/%m/%d",
                    ),
                ),
                (
                    "groupID",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "like",
                    models.ManyToManyField(
                        blank=True, related_name="likes2", to=settings.AUTH_USER_MODEL
                    ),
                ),
            ],
        ),
